...
my $numLines=4000;
#my @queryArray;
my $queryHeader="insert ignore into procnfs(cTime,cTime_usec,DT,DT_usec,ProducerName,CompId,jobid,nfs_numcalls_rate,nfs_create_rate,nfs_read_bytes_rate,nfs_write_bytes_rate) values ";
...
#    print "reading line $lineCounter\n";
    ...
    {
	($f1,$f2,$f3,$f4,$f5,$f6,$f7,$f8,$f9,$f10,$f11,$f12,$f13,$f14,$f15) = split(',',$line,$valCount);
        $values.="(".floor($f1).',';
