...
my $numLines=4000;
#my @queryArray;
my $queryHeader="insert ignore into procnetdev(cTime,cTime_usec,DT,DT_usec,ProducerName,CompId,jobid,eth0_rx_bytes_rate,eth0_tx_bytes_rate,eth2_rx_bytes_rate,eth2_tx_bytes_rate,ib0_rx_bytes_rate,ib0_tx_bytes_rate,ib1_rx_bytes_rate,ib1_tx_bytes_rate) values ";
...
#    print "reading line $lineCounter\n";
    ...
    {
	($f1,$f2,$f3,$f4,$f5,$f6,$f7,$f8,$f9,$f10,$f11,$f12,$f13,$f14,$f15) = split(',',$line,15);
        $values.="(".floor($f1).',';
	$values.="$f2,$f3,$f4,\'$f5\',$f6,$f7,$f8,$f9,$f10,$f11,$f12,$f13,$f14,$f15";	
	$values.="),\n";
#	print "values=$values\n";
    }
    else
