...
my $numLines=4000;
#my @queryArray;
my $queryHeader="insert ignore into loadavg(cTime,cTime_usec,ProducerName,CompId,jobid,load1min,load5min,load15min,runnable) values ";
...
#    print "reading line $lineCounter\n";
    ...
    {
	($f1,$f2,$f3,$f4,$f5,$f6,$f7,$f8,$f9,$f10,$f11,$f12) = split(',',$line,12);
        $values.="(".floor($f1).',';
	$f7=int(100*$f7);
	$f8=int(100*$f8);
	$f9=int(100*$f9);
	$values.="$f2,\'$f3\',$f4,$f5,$f7,$f8,$f9,$f10";	
	$values.="),\n";
#	print "values=$values\n";
    }
    else
