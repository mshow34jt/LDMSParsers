...
my $numLines=4000;
#my @queryArray;
my $queryHeader="insert ignore into opa2(cTime,cTime_usec,DT,DT_usec,ProducerName,CompId,jobid,PortXmitData_rate,PortRcvData,PortXmitPkts,PortRcvPkts) values ";
