...
my $numLines=4000;
#my @queryArray;
my $queryHeader="insert ignore into procstat_72(cTime,cTime_usec,DT,DT_usec,ProducerName,CompId,jobid,user_pct,nice_pct,sys_pct,idle_pct,iowait_pct,irq_rate,context_switches_rate,procs_running,procs_blocked) values ";
...
#    print "reading line $lineCounter\n";
    ...
    {
	($f1,$f2,$f3,$f4,$f5,$f6,$f7,$f8,$f9,$f10,$f11,$f12,$f13,$f14,$f15,$f16,$f17,$f18,$f19,$f20,$f21,$f22,$f23,$f24,$f25,$f26) = split(',',$line,$valCount);
        $values.="(".floor($f1).',';
	$values.="$f2,$f3,$f4,\'$f5\',$f6,$f7,$f8,$f10,$f12,$f14,$f16,$f18,$f20,$f22,$f24";	
	$values.="),\n";
#	print "values=$values\n";
    }
    else
